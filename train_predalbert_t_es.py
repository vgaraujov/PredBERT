...
from transformers import PredAlbertForPreTraining, PredAlbert2ForPreTraining
...
model = PredAlbert2ForPreTraining.from_pretrained(model_name, config=config)
