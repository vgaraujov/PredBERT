...
if is_torch_available():
    ...
    from .models.bert import (
        PredBertForPreTraining,
        PredBert2ForPreTraining,
    )
    ...
    from .trainer_pred import TrainerPred
