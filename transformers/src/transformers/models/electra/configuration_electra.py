...
class ElectraConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        k_size=2, # PredAlbert
        window_size=7, # PredAlbert
        all_layers=True, # PredAlbert
        until_layer=1, # PredAlbert
        **kwargs
    ):
        ...
        self.k_size = k_size # PredAlbert
        self.window_size = window_size # PredAlbert
        self.all_layers = all_layers # PredAlbert
        self.until_layer = until_layer # PredAlbert
